...
const AdvertiseSide = () => {
  return (
    <motion.div className="w-full overflow-hidden rounded-2xl" initial={{ opacity: 0, y: 25 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.2 }} transition={{ duration: 0.7, ease: "easeOut", }} >
      <Swiper
        spaceBetween={30}
        centeredSlides={true}
        loop={true}
